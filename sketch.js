...
// 1. Create a property this.isRemoved = false in constructor() of playerArrow.js and computerArrow.js.
// 2. Write the remove() function in playerArrow.js and computerArrow.js.
// 3. Create a function reduceLife() in player.js at each collision.
// 4. Create similar function in computerPlayer.js.
// 5. Modify showArrow() function in sketch.js to remove trajectory and arrows when it crosses out of canvas
// 6. Modify handlePlayerArrowCollision() and handleComputerArrowCollision() to reduce count in playerArcherLife & computerArcherLife variables at each collision.
// 7. Call reduceLife() function and change the property of computerPlayer, computerBase, player, playerBase to isStatic:false so that it falls off when all 3 lives are over.